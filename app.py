...
Main Application Entrypoint: app.py (v2.5 Enterprise Edition — Main Screen Auth & Clean Sidebar)
===================================================================================
Integrated Multi-Dashboard SaaS Platform with Main-Screen Auth, 20-Sector AI Detection,
24h/48h/72h/Permanent Pass Manager & Clean Architecture.
"""
...
# ==========================================
# 1. MAIN SCREEN AUTHENTICATION (NOT LOGGED IN)
# ==========================================
if not st.session_state["auth_role"]:
    st.markdown("""
    <div style="text-align: center; padding: 20px 0;">
        <img src="https://img.icons8.com/color/96/combo-chart.png" width="70"/>
        <h1 style="color: #FFFFFF; font-size: 32px; font-weight: 800; margin-top: 10px;">
            AMG Enterprise Analytics Portal
        </h1>
        <p style="color: #0284c7; font-size: 16px; font-weight: 600;">
...
<div style="background-color: #1A1F2B; border: 1px solid #2A3140; padding: 12px 24px; border-radius: 12px; margin-bottom: 20px;">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div>
            ...
            <b style="color: #0284c7; font-size: 15px;">{st.session_state['user_identity']}</b>
        </div>
    </div>
</div>
""", unsafe_allow_html=True)
