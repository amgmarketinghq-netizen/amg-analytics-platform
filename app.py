...
Main Application Entrypoint: app.py (v2.8 White & Gold Typography + Secure Auth)
===================================================================================
Integrated SaaS Platform with High-Visibility White/Gold Banner, Corner Branding,
Secrets-Driven Secure RBAC & 20-Sector AI Detection.
"""
...
# SECURE ADMIN PASSCODE LOOKUP (Zero hardcoded passwords visible in code)
def get_admin_passcode():
    try:
        ...
        pass
    import os
    return os.environ.get("ADMIN_PASSCODE", os.environ.get("ADMIN_PASSWORD", ""))
...
# ==========================================
# 1. MAIN SCREEN AUTHENTICATION (WHITE & GOLDEN TYPOGRAPHY)
# ==========================================
if not st.session_state["auth_role"]:
    # BANNER WITH BRIGHT WHITE TITLE & GOLDEN SUBTITLE
    st.markdown("""
    <div style="background: linear-gradient(135deg, #0F172A 0%, #1E293B 100%); border: 2px solid #334155; border-radius: 16px; padding: 32px 20px; text-align: center; margin-bottom: 25px; box-shadow: 0 10px 30px rgba(0,0,0,0.4);">
        <img src="https://img.icons8.com/color/96/combo-chart.png" width="65"/>
        <h1 style="color: #FFFFFF !important; font-size: 30px !important; font-weight: 800 !important; margin: 12px 0 6px 0 !important; letter-spacing: 0.5px; text-shadow: 0px 2px 4px rgba(0,0,0,0.8);">
            AMG Enterprise Analytics Portal
        </h1>
        <p style="color: #F59E0B !important; font-size: 16px !important; font-weight: 700 !important; margin: 0 !important; text-shadow: 0px 1px 3px rgba(0,0,0,0.8);">
        ...
        with tab_admin_login:
            ...
            with st.form("main_admin_login_form"):
                ...
                if admin_submit:
                    ...
                    if admin_pass_input and target_pass and admin_pass_input == target_pass:
