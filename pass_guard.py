...
=========================================================================
Admin Managed Client Email Activation with Secrets-Based VIP Authorization
"""

import datetime as dt
import streamlit as st

# Session state DB initialization (Clean, no hardcoded emails)
if "client_access_db" not in st.session_state:
    st.session_state["client_access_db"] = {}
    
    # Safely load Master VIP Email from Streamlit Secrets if configured
    try:
